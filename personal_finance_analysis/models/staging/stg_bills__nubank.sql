...
select
    ...
    transaction_date,
    case
        when transaction_description like 'Antecipada %' then 'Antecipation installment'
        ...
        when transaction_description like 'Crédito de "%"' then 'Refund'
        when transaction_description like 'Desconto Antecipação %' then 'Antecipation discount'
